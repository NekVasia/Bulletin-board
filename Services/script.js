...
const registration = () => {
    ...
    fetch("../API/User/registration.php", {
        method: "POST",
        headers: {
...
const login = () => {
    ...
    fetch(`../API/User/login.php?email=${encodeURIComponent(email)}&password=${encodeURIComponent(password)}`, {
        method: "GET",
        headers: {
            "Content-Type": "application/json",
        },
...
const getProduct = () => {
    fetch(`../API/Product/productShow.php`, {
        method: "GET",
        headers: {
            "Content-Type": "application/json",
        },
...
const getMyProduct = () => {
    fetch(`../API/Product/productShowMy.php`, {
        method: "GET",
        headers: {
            "Content-Type": "application/json",
        },
...
const createProduct = () => {
    ...
    fetch(`../API/Product/productCreate.php`, {
        method: "POST",
        body: formData,
    })
        .then(response => response.json())
...
const changeProduct = () => {
    ...
    fetch(`../API/Product/productChange.php`, {
        method: "POST",
        body: formData,
    })
        .then(response => response.json())
...
const deleteProduct = (event) => {
    ...
    fetch(`../API/Product/productDelete.php?productId=${encodeURIComponent(productId)}`, {
        method: "DELETE",
        headers: {
            "Content-Type": "application/json",
        },
...
const goToPhone = (event) =>{
    ...
    fetch(`../API/Product/productPhone.php?productId=${encodeURIComponent(productId)}`, {
        method: "GET",
        headers: {
            "Content-Type": "application/json",
        },
